...
export const metadata: Metadata = {
  title: "Terms of Use",
  description: "Terms for using Smokies Insider as a general trip-planning aid.",
};

export default function TermsPage() {
  return <PolicyPage title="Terms of Use" description="Use Smokies Insider as a general planning aid, not an official notice, reservation or guarantee." path="/terms" points={[
