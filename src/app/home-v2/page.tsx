...
title: "Smokies Insider | Smoky Mountains Trip Planning",
description:
...
function Logo() {
return ( <span className="homeV2Logo" aria-label="Smokies Insider"> <span className="homeV2LogoMark" aria-hidden="true"> <svg viewBox="0 0 92 58" role="img"> <path d="M4 49h84M11 44l9-14 8 10 16-26 12 18 9-12 18 24" /> <path d="M15 51V39M24 51V35M33 51V41" /> <path d="M13 40h11l-5-7-6 7Zm8-5h10l-5-7-5 7Zm7 8h13l-7-9-6 9Z" /> </svg> </span> <span> <strong>Smokies</strong> <small>Insider Guide</small> </span> </span>
);
}

export default function HomeV2Page() {
return ( <main className="homeV2"> <header className="homeV2Header"> <Link className="homeV2Brand" href="/" aria-label="Smokies Insider home"> <Logo /> </Link>
  ...
  <footer className="homeV2Footer">
    <div className="homeV2FooterInner">
      <Link className="homeV2FooterLogo" href="/" aria-label="Smokies Insider home">
        <Logo />
      </Link>
